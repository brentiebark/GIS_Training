...
* **4** - The sidebar navigation allows you to go to the previous or
  next topic.
...
* Menu and toolbar commands are shown as italic letters and (if available)
  preceded by an icon image, for example, :menuselection:`Print`
  or |mActionFilePrint|.

* A series of commands are written with -->. For example: :menuselection:`Project`
